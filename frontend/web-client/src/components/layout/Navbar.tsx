...
export default function Navbar() {
  ...
  const navLink = (
    ...
    >
      ...
      {showDot && <span className="h-2 w-2 rounded-full bg-green-500"></span>}
    </Link>
  );
  ...
  const icons = {
    ...
    mentorship: (
      ...
      >
        <path
          d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422M12 21l-9-5m18-1v1a2 2 0 01-2 2H5a2 2 0 01-2-2v-1"
          strokeWidth={2}
          strokeLinecap="round"
          strokeLinejoin="round"
        />
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
        ...
        <nav className="hidden items-center gap-1 md:flex">
          ...
          {navLink(
            ...
            "Chat",
            icons.chat,
            totalUnreadCount > 0 && location.pathname !== "/chat",
          )}
